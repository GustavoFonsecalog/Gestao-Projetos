            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                >
                    ...
                    <nav class="flex flex-1 justify-end gap-6">
                        <Link href="/sobre" class="font-bold text-white hover:underline">Sobre</Link>
                        <Link href="/funcionalidades" class="font-bold text-white hover:underline">Funcionalidades</Link>
                    </nav>
                </header>
